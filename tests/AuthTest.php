...
class AuthTest extends \PHPUnit\Framework\TestCase
{
    ...
    public static function setUpBeforeClass()
    {
        ...
        self::$dbh = new PDO("mysql:host=127.0.0.1;dbname=phpauthtest", "root", "arcangelo");
        self::$config = new PHPAuthConfig(self::$dbh);
        self::$auth   = new PHPAuth(self::$dbh, self::$config);
